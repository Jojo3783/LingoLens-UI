              ...
              children: [
                  ...
                  children: [
                    const Expanded(
                      child: LingoLensSectionHeader(
                        title: '最愛紀錄',
                        description:
                            '顯示已釘選的最愛分析紀錄（使用者主動標記 ⭐️，永久保存，不受 20 筆上限淘汰影響）。',
                      ),
                    ),
                ...
                if (_isLoading)
                  ...
                  () {
                    ...
                    return Column(
                      children: [
                        for (final record in filteredFavorites)
                          Padding(
